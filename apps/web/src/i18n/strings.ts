...
const en = {
  ...
  'court.how.expiry': 'A court lasts 30 days from the last time anyone paid. If nobody courts them again in that window, their court value falls to zero and the title disappears.',
  ...
  'court.thenZero': 'then it drops to 0',
...
const fa: T = {
  ...
  'court.how.expiry': 'هر دربار ۳۰ روز اعتبار دارد. اگر کسی دوباره او را دربار نکند، ارزش او صفر می‌شود.',
  'court.how.rank': 'ارزش دربار تنها جدولی است که پول مستقیم روی آن اثر می‌گذارد.',
  'court.thenZero': 'سپس به صفر می‌رسد',
  'court.lapsed': 'ارزش دربار شما در حال پایان است. توجه دوباره آن را به ۳۰ روز بازمی‌گرداند.',
